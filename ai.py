...
class Gametree:
	...
	def grow_once(self, state):
	    ...
	    direc[0] = new State(simulator0.tileMatrix, state.player, simulator0.total_points, state)
		direc[1] = new State(simulator1.tileMatrix, state.player, simulator1.total_points, state)
		direc[2] = new State(simulator2.tileMatrix, state.player, simulator2.total_points, state)
		direc[3] = new State(simulator3.tileMatrix, state.player, simulator3.total_points, state)
